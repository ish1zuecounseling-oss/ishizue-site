          ...
          <motion.div {...fadeIn} className="space-y-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="p-6 md:p-8 rounded-2xl border border-stone-100 hover:border-stone-200 transition-colors"
                >
            ...
            <div className="bg-stone-50/30 p-6 md:p-16 rounded-3xl border border-stone-100 space-y-10">
              ...
              <div className="text-stone-700 leading-loose space-y-8 text-base md:text-lg">
                ...
                <div className="pt-8 border-t border-stone-100">
                  <h4 className="text-xs font-medium text-stone-400 mb-4 tracking-[0.3em] uppercase">
                    活動歴
                  </h4>
