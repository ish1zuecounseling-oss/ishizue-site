...
const RESEARCH_PATHS = [
  ...
  "helper-empathy-fatigue",
  "helper-secondary-trauma",
  "helper-decision-fatigue",
  "helper-overwork",
  "helper-night-shift-mental-health",
  "helper-case-overload",
  "helper-guilt-about-leaving",
  "helper-leave-of-absence-hesitation",
  "helper-signs-to-rest",
  "helper-return-to-work-fear",
  "helper-counseling-when-quitting",
  "helper-career-stagnation",
  "helper-burnout-recovery",
  "helper-mental-recovery",
  "helper-rest-types",
  "helper-rest-importance",
  "helper-stress-coping",
  "helper-self-care",
  "helper-compassion-fatigue-practice",
  "helper-burnout-what-to-do",
  "helper-burnout-signs",
  "helper-pulled-by-client",
  "helper-cannot-say-no",
  "helper-boundary",
  "helper-boundary-how-to",
  "helper-guilt-about-suffering",
  "helper-perfectionism",
  "helper-social-worker-dilem",
  "helper-stop-self-sacrifice",
  "helper-boss-stress",
  "helper-complaint-damage",
  "helper-harassment-gray-zone",
  "helper-workplace-stress",
  "helper-team-fatigue",
  "helper-aptitude-doubt",
  "helper-burnout-vs-depression",
  "helper-counseling",
  "helper-online-counseling",
  "helper-receiving-counseling",
  "helper-resistance-to-counseling",
  "helper-cannot-seek",
  "empathy-fatigue-boundary",
  "empathy-fatigue-recovery",
  "empathy-fatigue-by-job-type",
  "compassion-fatigue-coping",
  "compassion-fatigue-diagnosis",
  "compassion-fatigue-vs-depression",
  "care-worker-burnout",
  "care-worker-mental-fatigue",
  "emotional-labor-fatigue",
  "nurse-compassion-fatigue",
  "nurse-emotional-exhaustion",
  "nurse-emotional-labor-hard",
  "nursery-teacher-limit",
  "nursery-teacher-relationship-stress",
  "school-counselor-loneliness",
  "teacher-mental-health",
  "teacher-mental-health-limit",
  "teacher-online-counseling",
  "welfare-worker-relationship-counseling",
  "helper-thinking-patterns",
  "helper-burnout",
];
