...
export const features: FeatureItem[] = [
  ...
  },
  {
    benefit: "完全プライベートな空間",
    title:   "職場にも家族にも知られない",
    desc: "オンライン完結（Google Meet）。移動不要、郵送物なし。職場や家族への通知はありません。領収書・明細はご希望の方のみ発行します。",
...
export const faqItems = [
  ...
  { q: "職場や家族に知られたくないのですが",       a: "完全オンラインのため、移動も不要です。郵送物はありません。領収書等の書類はご希望の場合のみ電子データで発行します。秘密にしたままご利用いただけます。",           emphasis: false },
